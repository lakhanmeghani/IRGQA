...
import fetchRecords from '@salesforce/apex/ProjectLookupController.fetchRecords';
/** The delay used when debouncing event handlers before invoking Apex. */
const DELAY = 500;

export default class ProjectLookup extends LightningElement {
    @api helpText = "Search Project";
    @api label = "Project";
    @api required;
    ...
    @api objectApiName = "sirenum__ProActiveContract__c";
    @api fieldApiName = "Name";
    @api otherFieldApiName = "Oracle_Project_Code__c";
    @api searchString = "";
